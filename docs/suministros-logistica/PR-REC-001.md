...
* **Qué HACE:**
    ...
    * Inspección, diagnóstico básico, prueba técnica en SmartOLT, limpieza, desinfección y rotulación de los equipos devueltos.
    * Reseteo de parámetros y actualización sistémica para categorización del activo.
...
| **3. Triaje y diagnóstico** | Clasificación visual por modelo y prueba técnica con configuraciones en SmartOLT para modelos viables. | MNT | MNT | TEC | - |
| **4. Reacondicionamiento y Recategorización** | Limpieza exterior, desinfección, reseteo a valores de fábrica, impresión/pegado de etiqueta térmica y egreso/reingreso sistémico en ítem categoría "(USADO)". | MNT | MNT | - | - |
